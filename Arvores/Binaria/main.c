...
int menu(){
    ...
    printf(" 8  - Imprimir Disciplinas de um Bloco especifico\n");
    ...
    while((opc = menu()) != 0){
        switch (opc)
        {
            ...
            case 5:// inserir disciplinas
                ...
                newDsc = criarDisciplina(codDsc,nomeDsc,bloco,c_Horaria);
                inserirDisciplinanoCurso(&raiz,idC,newDsc);
            ...
            case 6://ver todas as disciplinas de um curso
                ...
                printf("Codigo do curso: ");
                scanf("%d",&codigo);
                imprimirDisciplinas(raiz,codigo);
                break;
            ...
            case 10:// Remover um curso
                ...
                scanf("%d",&idCurso);
                raiz = buscarCursoRemover(raiz,idCurso);
                break;
            case 11: // remover uma disciplina
                ...
                printf("Codigo da disciplina: ");
                scanf("%d",&idDsc);
                buscarCursoRemoverDisciplina(&raiz,idCrs,idDsc);
                break;
            default:
